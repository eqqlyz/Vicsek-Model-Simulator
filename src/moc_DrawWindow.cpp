...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DrawWindow_t, stringdata) + ofs \
...
const QMetaObject DrawWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DrawWindow.data,
      qt_meta_data_DrawWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DrawWindow.stringdata))
        return static_cast<void*>(const_cast< DrawWindow*>(this));
